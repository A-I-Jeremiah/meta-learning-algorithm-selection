...
Curate ~20 diverse datasets from the Penn Machine Learning Benchmark (PMLB).



Extract a standard set of dataset meta-features.



Train five algorithms (Random Forest, Gradient Boosting, SVM, k-NN, Neural Network) with 5-fold stratified cross-validation.



Rank algorithms per dataset using normalised performance scores.



Train a meta-learner that predicts the best algorithm from meta-features alone.



Perform rigorous statistical tests (Friedman + Nemenyi, Wilcoxon signed-rank).



Model the entire experiment in XSD and provide XPath/XQuery extraction scripts.



Deliver an IMRAD manuscript (4 000–6 000 words, APA 7) and a 10-minute presentation.
...
Full ML pipeline, meta-learner, statistical tests, core notebooks, final reproducibility
...
Data Curator & Metadata Specialist



Dataset acquisition, cleaning, harmonisation, data dictionary & ethics documentation
...
Complete XSD schema + sample valid XML instances + validation proof
...
XPath/XQuery Developer



XPath & XQuery scripts for extraction and validation
...
Tables, Critical Difference diagram, feature-importance table, scatter plots, high-res figures
...
Full empirical manuscript (IMRAD, APA 7)
...
Presentation & Peer-Review Coordinator



10-minute MP4 + peer-review process + final packaging
...
Train five algorithms (5-fold stratified CV)
...
Export results for visualisation and XML teams
...
Primary source: Penn Machine Learning Benchmark (PMLB)
...
Create a branch named after your task, e.g.
...
The ML Engineer (Akindipe) reviews for correctness, style, and reproducibility.
...
Documented raw + processed datasets + data dictionary
...
Reproducible analysis code + notebooks



src/ + notebooks/ · Akindipe
...
XML Schema (XSD) + sample instances
...
Tables & high-resolution figures



figures/ + results/ · AKINYELE
...
Empirical manuscript (4–6 k words, IMRAD, APA 7)
...
Clean, runnable GitHub repository
...
Raw + processed data, metadata, ethics notes
...
Notebooks, statistical tests, figures
...
Valid XSD, sample XML, working queries





Empirical Manuscript (IMRAD)
...
Runnable repo, clear README, requirements.txt
...
For onboarding questions, open an Issue or contact the ML Engineer directly.
